...
device_id = "3"
client_id = "clientId0003-Producer"
...
def robot_parameter(WS_thre,FS_thre,user_command):
    ...
    robot = Robot(3,500,default_WS_thre,500,default_FS_thre,default_user_command)
    return robot
...
def on_message(client, userdata, msg):
    global robot_3 , WS_thre, FS_thre, user_command
    ...
    try:
        ...
        if command.get("action") == "start":
            ...
            robot_3 = robot_parameter(WS_thre,FS_thre,user_command)
            print("STARTING")
