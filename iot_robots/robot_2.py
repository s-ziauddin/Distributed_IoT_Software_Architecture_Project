...
def robot_parameter(WS_thre,FS_thre,user_command):
    ...
    robot = Robot(2,500,default_WS_thre,500,default_FS_thre,default_user_command)
    return robot
...
def on_message(client, userdata, msg):
    global robot_2 , WS_thre, FS_thre, user_command
    ...
    try:
        ...
        if command.get("action") == "start":
            ...
            robot_2 = robot_parameter(WS_thre,FS_thre,user_command)
            print("STARTING")
